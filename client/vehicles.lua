--- This script provides utility functions for managing vehicles.
-- It includes functions for fetching and retrieving vehicle-related data, as well as spawning vehicles with specific properties and modifications.
