--- This script manages ped creation, manipulation, and removal in the game environment.
-- It provides functionalities such as creating individual or multiple peds, giving weapons to peds, and removing peds individually or by categories.
