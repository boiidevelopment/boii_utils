--- This script provides a set of tools for developers to display on-screen information about coordinates, vehicles, players, and the game environment.
-- Useful for debugging and development purposes.
-- @script client/developer.lua

--- @section Local functions

--- Toggles the display of the current coordinates on the screen.
-- Displays the player's current position in different vector formats.
-- @function toggle_coords
-- @usage utils.developer.toggle_coords() -- Toggle the display of coordinates on/off.
...
--- Toggles the display of relevant vehicle information on the screen.
-- Displays details of the vehicle the player is currently in, such as model, speed, and health.
-- @function toggle_vehicle_info
-- @usage utils.developer.toggle_vehicle_info() -- Toggle the display of vehicle information on/off.
...
--- Toggles the display of detailed player information on the screen.
-- Displays various attributes of the player, such as health, stamina, and current model.
-- @function toggle_player_info
-- @usage utils.developer.toggle_player_info() -- Toggle the display of player information on/off.
...
--- Toggles the display of environment information on the screen.
-- Displays time, weather conditions, and the player's current direction and street name.
-- @function toggle_environment_info
-- @usage utils.developer.toggle_environment_info() -- Toggle the display of environment information on/off.
