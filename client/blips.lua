--- This script manages blip creation, manipulation, and visibility for the client.
-- It provides a comprehensive set of utilities for handling blips, including creating, showing/hiding, updating, and removing them.
