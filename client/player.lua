--- This script provides utility functions related to player actions and information retrieval in the game environment.
-- It includes functions for obtaining player direction, location, detailed information, target entities, and more.
