--- Drawing Utilities Script for BOII | Development Framework.
-- This script provides a collection of functions for drawing various elements on screen, such as text, lines, polygons, and sprites.
-- Useful for UI elements, debugging, and visual aids during development.
-- @script client/entities.lua
