--- This script provides utilities for interacting with the game's environment.
-- It includes functions to retrieve and format weather, time, and date information.
