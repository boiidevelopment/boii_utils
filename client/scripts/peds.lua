...
exports('peds_give_weapon', give_weapon)
utils.peds.give_weapon = give_weapon
...
exports('peds_create_ped', create_ped)
...
exports('peds_create_peds', create_peds)
...
exports('peds_remove_ped', remove_ped)
...
exports('peds_remove_all_peds', remove_all_peds)
...
exports('peds_remove_peds_by_categories', remove_peds_by_categories)
