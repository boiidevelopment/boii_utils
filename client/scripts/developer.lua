...
--- Developer functions.
--- @script client/scripts/developer.lua
...
exports('developer_toggle_coords', toggle_coords)
...
exports('developer_toggle_vehicle_info', toggle_vehicle_info)
...
exports('developer_toggle_player_info', toggle_player_info)
