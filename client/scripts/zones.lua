...
exports('zones_add_circle_zone', add_circle_zone)
...
exports('zones_add_box_zone', add_box_zone)
...
exports('zones_remove_zone', remove_zone)
...
exports('zones_is_in_zone', is_in_zone)
