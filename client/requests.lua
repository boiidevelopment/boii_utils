--- This script provides utility functions for requesting and loading various game assets and data.
-- It ensures that models, interiors, textures, collisions, animations, audio banks, scaleform movies, cutscenes, and ipl are properly loaded before use.
