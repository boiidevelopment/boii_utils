...
-- Usage: utils.serialization.save_table_to_file('your table', 'path/to/save.txt')
...
-- Function to pretty print a table as JSON
-- Usage: utils.serialization.pretty_print_json('your table')
local function pretty_print_json(tbl)
    return json.encode(tbl, {indent = true})
end

-- Function to convert a table to XML string
-- Usage: local xml_str = utils.serialization.table_to_xml('your table')
-- NOTE: This is a simplistic approach; might not cover all edge cases.
...
-- Usage: local encoded_data = utils.serialization.base64_encode('your string')
...
-- Usage: local decoded_data = utils.serialization.base64_decode('your encoded data')
