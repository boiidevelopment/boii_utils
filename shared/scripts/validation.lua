...
--- @script server/validation/validation.lua
...
exports('validation_has_min_length', has_min_length)
...
exports('validation_has_max_length', has_max_length)
...
exports('validation_matches_pattern', matches_pattern)
...
exports('validation_is_email', is_email)
...
exports('validation_is_alpha', is_alpha)
...
exports('validation_is_digit', is_digit)
...
exports('validation_is_alphanumeric', is_alphanumeric)
...
exports('validation_is_within_range', is_within_range)
...
exports('validation_is_url', is_url)
...
exports('validation_is_date', is_date)
...
exports('validation_is_username', is_username)
...
exports('validation_is_ip_address', is_ip_address)
...
exports('validation_is_server_address', is_server_address)
...
exports('validation_is_strong_password', is_strong_password)
...
exports('validation_is_hex_colour', is_hex_colour)
