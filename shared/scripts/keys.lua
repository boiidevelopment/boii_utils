...
--- Keys functions.
-- @script shared/scripts/keys.lua
...
exports('keys_get_key_name', get_key_name)
utils.keys.get_key_name = get_key_name

--- Prints the list of all keys and their codes.
--- This function logs all key names and their associated codes to the console.
--- @function print_key_list
...
exports('keys_print_key_list', print_key_list)
utils.keys.print_key_list = print_key_list

--- Checks if a key exists in the keys table.
--- This function checks if a given key name is present in the keys table.
--- @function key_exists
...
exports('keys_key_exists', key_exists)
utils.keys.key_exists = key_exists