...
exports('cooldowns_add', add_cooldown)
...
exports('cooldowns_check', check_cooldown)
...
exports('cooldowns_clear', clear_cooldown)
...
exports('cooldowns_clear_for_resource', clear_resource_cooldowns)
