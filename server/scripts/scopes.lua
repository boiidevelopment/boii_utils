...
--- Player scope functions.
-- @script server/scopes.lua
...
exports('scope_get_player_scope', get_player_scope)
...
exports('scope_trigger_scope_event', trigger_scope_event)
...
exports('scope_get_players_in_range', get_players_in_range)
