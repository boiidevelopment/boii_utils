...
local function initialize_licences(_src)
    ...
    if not response or #response == 0 then
        ...
        for licence_id, _ in pairs(config.licences) do
...
exports('licences_get', get_licences)
...
exports('licences_update', update_licence)
...
exports('licences_update_data', update_licence_data)
...
exports('licences_check_passed', check_licence_passed)
