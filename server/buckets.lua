--- This script provides utility functions for managing player buckets (isolated worlds).
-- It includes functions for setting players into specific buckets, retrieving bucket settings, and managing players within buckets.
